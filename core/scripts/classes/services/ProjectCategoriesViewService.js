			...
			_base.initializeClient(function() {
				...
				function getProjectCategories() {
					...
					_base.getFromCache(cacheKey, function(value) {
						...
						repo.getAllProjectCategories(_base.getClient(), options,
							function(x) {
							...
							function() {
								...
								_base.addError(new Error('Projets not found',
									404));
								deferred.reject();
							});
					});
				...
				function computeData(website, pages, menuEvents,
					...
					var viewData = getViewData(page, projectCategories,
						website);
				...
				function getViewData(page, projectCategories, website) {
					...
					for (var i = 0; i < projectCategories.length; i++) {
						...
						data
							.projectCategories[data.projectCategories.length - 1]
