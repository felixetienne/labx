(function(q, pg, dateFormat, repositoriesFactory, config, cache,
  ...
  module.exports = function(context) {
    ...
    this.getBasicOptions = getBasicOptions;

    function getBasicOptions() {
      var options = {
        publishedOnly: !context.includesDraft()
      };
    ...
    this.getWebsite = function() {
      ...
      getFromCache(cacheKey, function(value) {
        ...
        options.websiteName = context.getCurrentWebsite();

        repo.getWebsiteByName(_client, options,
          function(x) {
    ...
    this.getPage = function() {
      ...
      getFromCache(cacheKey, function(value) {
        ...
        options.pageName = _currentPage;

        repo.getPageByName(_client, options,
          function(x) {
            addToCache(cacheKey, x, function() {
              deferred.resolve(x);
            });
    ...
    this.getPages = function() {
      ...
      getFromCache(cacheKey, function(value) {
        ...
        repo.getAllPages(_client, options,
          function(x) {
            addToCache(cacheKey, x, function() {
              deferred.resolve(x);
            });
    ...
    this.getMenuEvents = function() {
      ...
      getFromCache(cacheKey, function(value) {
        ...
        options.maximumEvents = _maximumEventsInMenu >
          _maximumLastEvents ?
          _maximumEventsInMenu : _maximumLastEvents;

        repo.getMenuEvents(_client, options,
          function(x) {
            addToCache(cacheKey, x, function() {
              deferred.resolve(x);
            });
    ...
    this.getMenuProjectCategories = function() {
      ...
      getFromCache(cacheKey, function(value) {
        ...
        repo.getMenuProjectCategories(_client, options,
          function(x) {
            addToCache(cacheKey, x, function() {
              deferred.resolve(x);
            });
    ...
    this.getFeaturedProjects = function() {
      ...
      if (viewHelpers.hasFeaturedProjects(_currentPage)) {
        ...
        options.exludedProjectName = _currentPage === _projectPage ?
          _currentName : null;

        repo.getFeaturedProjects(_client, options,
          function(x) {
            deferred.resolve(x);
          },
          function() {
    ...
    this.getImageBanners = function() {
      ...
      if (viewHelpers.hasBanners(_currentPage)) {
        ...
        repo.getBanners(_client, options,
          function(x) {
            deferred.resolve(x);
          },
          function() {
