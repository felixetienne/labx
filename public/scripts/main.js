...
window.main.dependancies = (function(dependancies) {
  ...
  for (var k in dependancies) {
    if (dependancies.hasOwnProperty(k) && typeof dependancies[k] ===
      'undefined') throw '[ERROR] The dependancy "' + k +
      '" is not defined.';
  }
...
(function(main) {
  ...
  main.classes = (function(mod, context) {
    ...
    mod.NullOrUndefniedExeption = function(objName) {
      var base = new BaseExeption('The object "' + objName +
